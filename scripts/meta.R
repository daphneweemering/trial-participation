...
#### FIGURE ####
pdf(file = '/Users/dweemeri/surfdrive - Weemering, D.N. (Daphne)@surfdrive.surf.nl/trial participation/trial-participation/figures/figure4.pdf',
    width = 11.7, height = 7)
...
#### FUNNEL PLOTS ####
pdf(file = "/Users/dweemeri/surfdrive - Weemering, D.N. (Daphne)@surfdrive.surf.nl/trial participation/trial-participation/figures/suppl_fig_1.pdf",
    height = 8, width = 8)

# define titles and y-axis limits for each plot
pi <- list(
  list(title = "Relationship with clinical staff", ylim = c(0.5, 0)),
  list(title = "Information provided", ylim = c(1.1, 0)),
  list(title = "Placebo/sham use", ylim = c(1.5, 0)),
  list(title = "Side effects", ylim = c(0.75, 0))  # No ylim specified for the last plot
)
...
Map(function(data, info){
  ...
  funnel(m, ylim = info$ylim, xlab = "", ylab = "",
